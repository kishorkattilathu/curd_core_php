...
if (isset($_POST['login'])) {
    ...
    if ($user) {
        // Now use password_verify() to check if the password matches the hashed password
        if (password_verify($password, $user['password'])) {
            // If the password is correct, redirect to dashboard
            echo "Login successful. Redirecting to dashboard...";
            header('Location: dashboard.php'); // Adjust the redirect URL as needed
            exit();
        } else {
